...
2019-05-07： 更改成Ubuntu16.04的版本， 测试通过可用
...
Download the [Room Example Sequence](http://vmcremers8.informatik.tu-muenchen.de/lsd/LSD_room.bag.zip) and extract it. (下载测试的数据集， rosbag包)
...
If you want to directly use a camera.(使用image_topic消息形式)
...
Alternatively, you can specify a calibration file using (使用calibraiton_file文件形式)
